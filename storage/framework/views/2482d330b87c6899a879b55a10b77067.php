...
<body>
    <header class="main-header">
        ...
        <div class="header-user" id="headerUser">
            <span class="header-username"><?php echo e(Auth::user()->nama); ?></span>
...
</html> <?php /**PATH P:\Coding Files Projects\mms-project-repo\resources\views/product-customer.blade.php ENDPATH**/ ?>